...
describe('update cases resource', () => {
    ...
    it('should error if path and payload do not match', async () => {
        ...
        expect(updateCases(event, dummyContext, repositoryProvider)).rejects.toThrow("Requested Case Ulid does not match resource");
    });
    ...
    it('should error if no payload is provided', async () => {
        ...
        expect(updateCases(event, dummyContext, repositoryProvider)).rejects.toThrow("Update cases payload missing.");
    });
    ...
    it('should error if a path parameter specifying caseId is not found', async () => {
        ...
        await expect(updateCases(event, dummyContext, repositoryProvider)).rejects.toThrow("Required path param 'caseId' is missing.");
    });
    ...
    it('should not allow update of status', async () => {
        ...
        await expect(updateCases(event, dummyContext, repositoryProvider)).rejects.toThrow("\"status\" is not allowed");
    });
    ...
    it('should not allow update of objectCount', async () => {
        ...
        await expect(updateCases(event, dummyContext, repositoryProvider)).rejects.toThrow("\"objectCount\" is not allowed");
    });
    ...
    it('should error when updating to a name in use', async () => {
        ...
        await expect(updateCases(event, dummyContext, repositoryProvider)).rejects.toThrow("Cannot update unique attributes \"name\" for \"Case\". An item of the same name already exists.");
    });
