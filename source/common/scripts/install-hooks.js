...
function usage() {
  console.log(
    `This script installs the git-hooks from ${rootdir}/source/common/git-hooks folder to ${rootdir}/.git/hooks folder\n`
  );
...
const srcDir = `${rootdir}/source/common/git-hooks`;
...
if (retCode === 0) {
  ...
  console.log(
    "!!!! Something went wrong...please check with the repo maintainers !!!!"
  );
}
